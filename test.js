...
test('`background-color`', async t => {
	...
	const result = await arvish('node index.js background-color');
...
test('`align-content` on Gecko', async t => {
	const arvish = arvishTest();
	const result = await arvish('node index.js align-content --gecko');
...
test('`background-blend-mode` on edge', async t => {
	const arvish = arvishTest();
	const result = await arvish('node index.js blend-mode --edge');
